      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-[2fr_1fr_1fr_1fr] gap-12 mb-14">
          ...
          <div>
            ...
            <p className="text-white/28 text-sm font-light leading-relaxed max-w-xs mb-5">
          ...
          {/* Services */}
          <div>
            <h4 className="text-white/22 text-[9px] tracking-[0.4em] uppercase mb-5">Services</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={label}>
                  <a href={href} className="text-white/35 hover:text-[#c9a86c] text-sm font-light transition-colors">
                    {label}
                  </a>
                </li>
              ))}
          ...
          {/* Explore */}
          <div>
            <h4 className="text-white/22 text-[9px] tracking-[0.4em] uppercase mb-5">Explore</h4>
            <ul className="space-y-3">
              {[
                ["About", "#about"],
                ["The Method", "#method"],
          ...
          {/* Connect */}
          <div>
            <h4 className="text-white/22 text-[9px] tracking-[0.4em] uppercase mb-5">Connect</h4>
            <ul className="space-y-3">
              <li>
                <a href={SOCIAL.instagram} target="_blank" rel="noopener noreferrer"
                   className="text-white/35 hover:text-[#c9a86c] text-sm font-light transition-colors flex items-center gap-2">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-3">
          <span className="text-white/18 text-xs">© 2026 Christina Steinhoff. All rights reserved. · {SITE.location}</span>
          <div className="flex gap-6">
            {[["Privacy Policy", "https://christinasteinhoff.com/privacy-policy/"], ["Terms", "https://christinasteinhoff.com/legal-terms/"]].map(([label, href]) => (
              <a key={label} href={href} target="_blank" rel="noopener noreferrer" className="text-white/18 hover:text-white/35 text-xs transition-colors">
                {label}
              </a>
            ))}
          </div>
